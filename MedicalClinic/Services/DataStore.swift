...
final class DataStore {
    ...
    let analyzes = [
        ...
        "Гемостаз": [
            ...
            "Тромбодинамика",
            "Ингибитор плазмина (антиплазмин)",
            "Гемостаз Мини",
            "Протеин S"
        ]
    ]
    ...
    let analyzesResults = [
        ["0,1-0,34 IgE", "< 13.3 нг/мл"],
        ["", ""],
        ["", ""],
        ["124 %", "150 нг/мл", "65 %", "110%"],
        ["2.30 нг/мл", "4-8,3 пмоль/л", "150 мкг/сут"]
       
    ]
    
    let analyzesResultsStatus = [
        ["Отрицательный", "Положительный"],
        ["Данное исследование находится в работе", "Данное исследование находится в работе"],
        ["Данное исследование находится в работе", "Данное исследование находится в работе"],
